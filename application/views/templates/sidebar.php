...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('user/checkUser') ?>">
    ...
    <?php foreach ($menu as $m) : ?>
        ...
        <?php foreach ($subMenu as $sm) : ?>
            <!-- untuk mengaktifkan warna menu dan sub menu -->
